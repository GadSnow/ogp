...
export class EditSecteur implements OnInit {
    ...
    ngOnInit(): void {
        this.route.paramMap.subscribe((params) => {
            this.idSecteur = params.get('id');
            if (this.idSecteur) {
                this.loadQuartiers();
                this.loadSecteur(this.idSecteur);
            }
        });
    }
            ...
            .subscribe({
                next: (data) => {
                    this.form.patchValue({
                        ...
                        idQuartier: data.data.quartier.id
                    });
                },
                error: (err) => {
    ...
    validate() {
        ...
        this.secteurService
            .updateSecteur(idQuartier, secteurData)
            .pipe(finalize(() => this.isLoading.set(false)))
            .subscribe({
                next: (data) => {
