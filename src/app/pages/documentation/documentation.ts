...
@Component({
    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-4">Avalon is an application template for Angular and is distributed as a CLI project. Current versions are Angular v21 with PrimeNG v21. In case CLI is not installed already, use the command below to set it up.</p>
            <pre class="app-code">
